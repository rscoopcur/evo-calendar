...
; (function (factory) {
  ...
  EvoCalendar.prototype.initEventListener = function () {
    ...
    // IF sidebarToggler: set event listener: toggleEventList
    if (_.options.sidebarToggler) {
      _.$elements.sidebarToggler
        .off('click.evocalendar')
        .on('click.evocalendar', _, _.toggleSidebarEvent);
        _.$elements.sidebarToggler.addClass('open');
    }
    ...
    if (_.options.eventListToggler) {
      _.$elements.eventListToggler
        .off('click.evocalendar')
        .on('click.evocalendar', _, _.toggleEventListEvent,);
        _.$elements.eventListToggler.addClass('open');
    }
  ...
  ****************/
  ...
  EvoCalendar.prototype.selectYear = function (event) {
    ...
    $(_.$elements.calendarEl).trigger("selectYear", [_.$active.year, _.$active.date])
  ...
  EvoCalendar.prototype.selectMonth = function (event) {
    ...
    $(_.$elements.calendarEl).trigger("selectMonth", [_.initials.dates[_.options.language].months[_.$active.month], _.$active.month, _.$active.date])
  };
  ...
  EvoCalendar.prototype.toggleSidebarEvent = function (event) {
    ...
    if (_.$UI.hasSidebar) {
      $(this).trigger('sideBar:Opened')
    } else {
      $(this).trigger('sideBar:Closed')
    }
  ...
  EvoCalendar.prototype.toggleEventListEvent = function (event) {
    event.preventDefault() // 
    var _ = event.data;
    ...
    if (_.$UI.hasEvent) {
      $(this).addClass('open')
      $(this).attr('title', "Close eventlist")
    } else {
      $(this).removeClass('open')  
      $(this).attr('title', "Open eventlist")
    }
    if (_.windowW <= _.$breakpoints.tablet) {
      if (_.$UI.hasEvent && _.$UI.hasSidebar) _.toggleSidebar();
    }
    if (_.$UI.hasEvent) {
      $(this).trigger('eventList:Opened')
    } else {
      $(this).trigger('eventList:Closed')
    }
